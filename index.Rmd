...
The goal is to do a general analysis about the principal items that can be bought, which is the most sold one and which is the less sold one. Also talk about the one that gives us the best income and the one that gives us the worst income. Another part of the analysis is to look for the principal shipping methods and try to find why that method is the most used one and finally the principal payment methods. 
